...
//       if (window.ethereum) {
//         const provider = new BrowserProvider(window.ethereum);
//         const accounts = await provider.listAccounts(); // Returns an array of strings
//         if (accounts.length > 0) {
//           setWalletAddress(String(accounts[0])); // Set the first account as walletAddress
//           setConnected(true);
//         }
//       }
//     };
...
//               }  font-bold py-2 px-4 rounded-md cursor-pointer hover:bg-opacity-75`}
